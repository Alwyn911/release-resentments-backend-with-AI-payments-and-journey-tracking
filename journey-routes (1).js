  ...
  try {
    ...
    res.json({
      ...
      stats: {
        ...
        aiConversations: user.stats.totalAIConversations,
        zoomSessions: user.stats.totalZoomSessions,
      ...
      recentActivity: {
        lastJourneyStarted: user.journeys.length > 0 
          ? user.journeys[user.journeys.length - 1].startDate 
          : null,
        lastResourceCompleted: user.completedResources.length > 0 
          ? user.completedResources[user.completedResources.length - 1].completedAt 
          : null
      }
    });
